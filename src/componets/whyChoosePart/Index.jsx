...
import {
  faLaptopCode, faServer, faTools, faRocket
              ...
              <Row className="justify-content-center">
                ...
                >
                  <div className="single-choose text-center mt-30">
                    ...
                    <h4 className="title"> The Fastest Visa Procurement Process</h4>
                  </div>
                </div>
                <div
                  className="col-lg-4 col-md-6 col-sm-9 wow slideInUp"
                ...
                >
                  <div className="single-choose text-center mt-30">
                    ...
                    <h4 className="title">The process of getting a visa is the simplest and hassle-free</h4>
                  </div>
                </div>
                <div
                  className="col-lg-4 col-md-6 col-sm-9 wow slideInUp"
              ...
              <Row className="justify-content-center">
                ...
                >
                  <div className="single-choose text-center mt-30">
                    ...
                    <h4 className="title">More than 20 years of experience in the field of visa processing and highly skilled in immigration matters</h4>
                  </div>
                </div>
                <div
                  className="col-lg-4 col-md-6 col-sm-9 wow slideInUp"
                ...
                >
                  <div className="single-choose text-center mt-30">
                    ...
                    <h4 className="title">A comfortable and easy-to-reach office, in the center of Jakarta</h4>
                  </div>
                </div>
                <div
                  className="col-lg-4 col-md-6 col-sm-9 wow slideInUp"
                ...
                >
                  <div className="single-choose text-center mt-30">
                    ...
                    <h4 className="title">The work team is friendly, professional and happy to do their job</h4>
                  </div>
                </div>
              </Row>
            </Container>
